...
object AutomationCallers {
     ...
     */
    // Kept as a declaration rather than a bare comment so the command travels with the KDoc above it,
    // which is the part that matters: the pins must stay re-derivable by whoever reads this next.
